...
class numeric_limits<BOOST_LLT> {
 public:
  ...
  static BOOST_LLT max BOOST_PREVENT_MACRO_SUBSTITUTION() {
...
#else
  static BOOST_LLT min BOOST_PREVENT_MACRO_SUBSTITUTION() {
    return 1LL << (sizeof(BOOST_LLT) * CHAR_BIT - 1);
  }
  static BOOST_LLT max BOOST_PREVENT_MACRO_SUBSTITUTION() { return ~(min)(); }
#endif
  BOOST_STATIC_CONSTANT(int, digits = sizeof(BOOST_LLT) * CHAR_BIT - 1);
  BOOST_STATIC_CONSTANT(int, digits10 = (CHAR_BIT * sizeof(BOOST_LLT) - 1) *
                                        301L / 1000);
...
class numeric_limits<BOOST_ULLT> {
 public:
  ...
  static BOOST_ULLT max BOOST_PREVENT_MACRO_SUBSTITUTION() {
  ...
  BOOST_STATIC_CONSTANT(int, digits10 = (CHAR_BIT * sizeof(BOOST_LLT)) * 301L /
                                        1000);
