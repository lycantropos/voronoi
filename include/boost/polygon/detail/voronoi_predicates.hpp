...
class voronoi_predicates {
 public:
  ...
  static fpt_type robust_cross_product(int_x2_type a1_, int_x2_type b1_,
                                       int_x2_type a2_, int_x2_type b2_) {
  ...
  typedef struct orientation_test {
   public:
    ...
    enum Orientation { RIGHT = -1, COLLINEAR = 0, LEFT = 1 };
    ...
    static Orientation eval(int_x2_type dif_x1_, int_x2_type dif_y1_,
                            int_x2_type dif_x2_, int_x2_type dif_y2_) {
      return eval(robust_cross_product(dif_x1_, dif_y1_, dif_x2_, dif_y2_));
    }

    template <typename Point>
    static Orientation eval(const Point& point1, const Point& point2,
                            const Point& point3) {
   ...
   public:
    ...
    bool operator()(const site_type& lhs, const site_type& rhs) const {
      ...
      if (!lhs.is_segment()) {
        ...
        if (is_vertical(rhs)) return lhs.y0() <= rhs.y0();
        return true;
      } else {
        if (is_vertical(rhs)) {
          if (is_vertical(lhs)) return lhs.y0() < rhs.y0();
          return false;
        }
        if (is_vertical(lhs)) return true;
  ...
  class distance_predicate {
   public:
    ...
    bool operator()(const site_type& left_site, const site_type& right_site,
   ...
   private:
    ...
    enum kPredicateResult { LESS = -1, UNDEFINED = 0, MORE = 1 };
    ...
    bool pp(const site_type& left_site, const site_type& right_site,
            const point_type& new_point) const {
      const point_type& left_point = left_site.point0();
      const point_type& right_point = right_site.point0();
      if (left_point.x() > right_point.x()) {
        if (new_point.y() <= left_point.y()) return false;
      } else if (left_point.x() < right_point.x()) {
        if (new_point.y() >= right_point.y()) return true;
      } else {
    ...
    bool ps(const site_type& left_site, const site_type& right_site,
      ...
      kPredicateResult fast_res =
          fast_ps(left_site, right_site, new_point, reverse_order);
    ...
    bool ss(const site_type& left_site, const site_type& right_site,
            const point_type& new_point) const {
      // Handle temporary segment sites.
      if (left_site.sorted_index() == right_site.sorted_index()) {
        return ot::eval(left_site.point0(), left_site.point1(), new_point) ==
               ot::LEFT;
      }
    ...
    fpt_type find_distance_to_segment_arc(const site_type& site,
      ...
      if (is_vertical(site)) {
        ...
        return k *
               robust_cross_product(static_cast<int_x2_type>(segment1.x()) -
    ...
    kPredicateResult fast_ps(const site_type& left_site,
      ...
      if (is_vertical(right_site)) {
        ...
        typename ot::Orientation orientation =
            ot::eval(static_cast<int_x2_type>(segment_end.x()) -
        ...
        if (orientation == ot::LEFT) {
          if (!right_site.is_inverse()) return reverse_order ? LESS : UNDEFINED;
  ...
  class node_comparison_predicate {
   public:
    ...
    bool operator()(const node_type& node1, const node_type& node2) const {
      ...
      if (point1.x() < point2.x()) {
        ...
        return distance_predicate_(node1.left_site(), node1.right_site(),
                                   point2);
      } else if (point1.x() > point2.x()) {
        // The first node contains a new site.
        return !distance_predicate_(node2.left_site(), node2.right_site(),
                                    point1);
      } else {
   ...
   private:
    ...
    const point_type& get_comparison_point(const site_type& site) const {
      return point_comparison_(site.point0(), site.point1()) ? site.point0()
                                                             : site.point1();
    }
    ...
    std::pair<coordinate_type, int> get_comparison_y(
      ...
      if (node.left_site().sorted_index() > node.right_site().sorted_index()) {
        if (!is_new_node && node.left_site().is_segment() &&
  ...
  class circle_existence_predicate {
   public:
    ...
    bool ppp(const site_type& site1, const site_type& site2,
             const site_type& site3) const {
      return ot::eval(site1.point0(), site2.point0(), site3.point0()) ==
             ot::RIGHT;
    }

    bool pps(const site_type& site1, const site_type& site2,
             const site_type& site3, int segment_index) const {
      if (segment_index != 2) {
        typename ot::Orientation orient1 =
            ot::eval(site1.point0(), site2.point0(), site3.point0());
        typename ot::Orientation orient2 =
            ot::eval(site1.point0(), site2.point0(), site3.point1());
        if (segment_index == 1 && site1.x0() >= site2.x0()) {
          if (orient1 != ot::RIGHT) return false;
        } else if (segment_index == 3 && site2.x0() >= site1.x0()) {
          if (orient2 != ot::RIGHT) return false;
    ...
    bool pss(const site_type& site1, const site_type& site2,
             const site_type& site3, int point_index) const {
      if (site2.sorted_index() == site3.sorted_index()) {
        return false;
      }
      if (point_index == 2) {
        if (!site2.is_inverse() && site3.is_inverse()) return false;
        if (site2.is_inverse() == site3.is_inverse() &&
            ot::eval(site2.point0(), site1.point0(), site3.point1()) !=
                ot::RIGHT)
          return false;
      }
      return true;
    ...
    bool sss(const site_type& site1, const site_type& site2,
             const site_type& site3) const {
  ...
  class mp_circle_formation_functor {
   public:
    ...
    void ppp(const site_type& site1, const site_type& site2,
             const site_type& site3, circle_type& circle,
             bool recompute_c_x = true, bool recompute_c_y = true,
      ...
      sum_y[1] = static_cast<int_x2_type>(site2.y()) +
                 static_cast<int_x2_type>(site3.y());
      fpt_type inv_denom =
          to_fpt(0.5) / to_fpt(static_cast<big_int_type>(dif_x[0] * dif_y[1] -
                                                         dif_x[1] * dif_y[0]));
    ...
    void pps(const site_type& site1, const site_type& site2,
             const site_type& site3, int segment_index, circle_type& c_event,
             bool recompute_c_x = true, bool recompute_c_y = true,
             bool recompute_lower_x = true) {
      ...
      if (is_zero(denom)) {
        ...
        if (recompute_c_x) c_event.x(to_fpt(0.25) * to_fpt(cA[0]) * inv_denom);
        if (recompute_c_y) c_event.y(to_fpt(0.25) * to_fpt(cA[2]) * inv_denom);
        if (recompute_lower_x) {
    ...
    // Recompute parameters of the circle event using high-precision library.
    void pss(const site_type& site1, const site_type& site2,
             const site_type& site3, int point_index, circle_type& c_event,
             bool recompute_c_x = true, bool recompute_c_y = true,
             bool recompute_lower_x = true) {
      ...
      if (is_zero(orientation)) {
        fpt_type denom =
            to_fpt(2.0) *
            to_fpt(static_cast<big_int_type>(a[0] * a[0] + b[0] * b[0]));
      ...
      big_int_type sign =
          ((point_index == 2) ? 1 : -1) * (is_neg(orientation) ? 1 : -1);
      cA[0] = a[1] * -dx + b[1] * -dy;
      cA[1] = a[0] * -dx + b[0] * -dy;
      cA[2] = sign;
      cA[3] = 0;
      ...
      fpt_type temp =
          to_fpt(sqrt_expr_evaluator_pss4<big_int_type, efpt_type>(cA, cB));
    ...
    // Recompute parameters of the circle event using high-precision library.
    void sss(const site_type& site1, const site_type& site2,
             const site_type& site3, circle_type& c_event,
             bool recompute_c_x = true, bool recompute_c_y = true,
             bool recompute_lower_x = true) {
      ...
      for (int i = 0; i < 3; ++i) cB[i] = a[i] * a[i] + b[i] * b[i];
   ...
   private:
    ...
    _fpt sqrt_expr_evaluator_pss4(_int* A, _int* B) {
      ...
      if (is_zero(A[3])) {
        ...
        cB[1] = 1;
        _fpt rh =
            sqrt_expr_.eval1(A + 2, B + 3) * get_sqrt(sqrt_expr_.eval2(cA, cB));
        if ((!is_neg(lh) && !is_neg(rh)) || (!is_pos(lh) && !is_pos(rh)))
          return lh + rh;
        cA[0] =
            A[0] * A[0] * B[0] + A[1] * A[1] * B[1] - A[2] * A[2] * B[3] * B[2];
        cB[0] = 1;
    ...
    _fpt sqrt_expr_evaluator_pss3(_int* A, _int* B) {
      ...
      if ((!is_neg(lh) && !is_neg(rh)) || (!is_pos(lh) && !is_pos(rh)))
        return lh + rh;
      cA[0] = A[0] * A[0] * B[0] + A[1] * A[1] * B[1] - A[2] * A[2] -
              A[3] * A[3] * B[0] * B[1];
      cB[0] = 1;
   ...
   public:
    ...
    void ppp(const site_type& site1, const site_type& site2,
      ...
      fpt_type orientation =
          robust_cross_product(static_cast<int_x2_type>(site1.x()) -
                                   static_cast<int_x2_type>(site2.x()),
                               static_cast<int_x2_type>(site2.x()) -
                                   static_cast<int_x2_type>(site3.x()),
                               static_cast<int_x2_type>(site1.y()) -
      ...
      if (recompute_c_x || recompute_c_y || recompute_lower_x) {
        exact_circle_formation_functor_.ppp(site1, site2, site3, c_event,
    ...
    void pps(const site_type& site1, const site_type& site2,
      ...
      robust_fpt_type teta(
          robust_cross_product(static_cast<int_x2_type>(site3.y1()) -
                                   static_cast<int_x2_type>(site3.y0()),
                               static_cast<int_x2_type>(site3.x0()) -
                                   static_cast<int_x2_type>(site3.x1()),
                               static_cast<int_x2_type>(site2.x()) -
          ...
          to_fpt(1.0));
      robust_fpt_type A(
          robust_cross_product(static_cast<int_x2_type>(site3.y0()) -
                                   static_cast<int_x2_type>(site3.y1()),
                               static_cast<int_x2_type>(site3.x0()) -
                                   static_cast<int_x2_type>(site3.x1()),
                               static_cast<int_x2_type>(site3.y1()) -
      ...
      robust_fpt_type denom(
          robust_cross_product(static_cast<int_x2_type>(site1.y()) -
                                   static_cast<int_x2_type>(site2.y()),
                               static_cast<int_x2_type>(site1.x()) -
                                   static_cast<int_x2_type>(site2.x()),
                               static_cast<int_x2_type>(site3.y1()) -
                               ...
                               static_cast<int_x2_type>(site3.x1()) -
                                   static_cast<int_x2_type>(site3.x0())),
          to_fpt(1.0));
      robust_fpt_type inv_segm_len(
          to_fpt(1.0) / get_sqrt(line_a * line_a + line_b * line_b),
          to_fpt(3.0));
      robust_dif_type t;
      ...
      bool recompute_lower_x = lower_x.dif().ulp() > ULPS;
      if (recompute_c_x || recompute_c_y || recompute_lower_x) {
        exact_circle_formation_functor_.pps(site1, site2, site3, segment_index,
                                            c_event, recompute_c_x,
    ...
    void pss(const site_type& site1, const site_type& site2,
      ...
      robust_fpt_type orientation(
          robust_cross_product(static_cast<int_x2_type>(segm_end1.y()) -
                                   static_cast<int_x2_type>(segm_start1.y()),
      ...
      if (ot::eval(orientation) == ot::COLLINEAR) {
        ...
        robust_fpt_type det(
            ...
            to_fpt(3.0));
        robust_dif_type t;
        t -= robust_fpt_type(a1) * robust_fpt_type((to_fpt(segm_start1.x()) +
                                                    to_fpt(segm_start2.x())) *
                                                       to_fpt(0.5) -
                                                   to_fpt(site1.x()));
        t -= robust_fpt_type(b1) * robust_fpt_type((to_fpt(segm_start1.y()) +
                                                    to_fpt(segm_start2.y())) *
                                                       to_fpt(0.5) -
                                                   to_fpt(site1.y()));
        if (point_index == 2) {
          t += det.sqrt();
        ...
        robust_dif_type c_x, c_y;
        c_x += robust_fpt_type(
            to_fpt(0.5) * (to_fpt(segm_start1.x()) + to_fpt(segm_start2.x())));
        c_x += robust_fpt_type(a1) * t;
        c_y += robust_fpt_type(
            to_fpt(0.5) * (to_fpt(segm_start1.y()) + to_fpt(segm_start2.y())));
        ...
        robust_fpt_type a(
            robust_cross_product(static_cast<int_x2_type>(segm_end1.x()) -
                                     static_cast<int_x2_type>(segm_start1.x()),
                                 static_cast<int_x2_type>(segm_end1.y()) -
                                     static_cast<int_x2_type>(segm_start1.y()),
                                 static_cast<int_x2_type>(segm_start2.y()) -
        ...
        robust_fpt_type or1(
            ...
            to_fpt(1.0));
        robust_fpt_type or2(
            robust_cross_product(static_cast<int_x2_type>(segm_end2.x()) -
                                     static_cast<int_x2_type>(segm_start2.x()),
                                 static_cast<int_x2_type>(segm_end2.y()) -
                                     static_cast<int_x2_type>(segm_start2.y()),
                                 static_cast<int_x2_type>(segm_end2.x()) -
      ...
      if (recompute_c_x || recompute_c_y || recompute_lower_x) {
        exact_circle_formation_functor_.pss(site1, site2, site3, point_index,
                                            c_event, recompute_c_x,
                                            recompute_c_y, recompute_lower_x);
      }
    }
    ...
    void sss(const site_type& site1, const site_type& site2,
      ...
      robust_fpt_type cross_12(
          robust_cross_product(static_cast<int_x2_type>(site1.x1()) -
                               ...
                               static_cast<int_x2_type>(site2.y1()) -
                                   static_cast<int_x2_type>(site2.y0())),
          to_fpt(1.0));
      robust_fpt_type cross_23(
          robust_cross_product(static_cast<int_x2_type>(site2.x1()) -
                                   static_cast<int_x2_type>(site2.x0()),
                               static_cast<int_x2_type>(site2.y1()) -
                                   static_cast<int_x2_type>(site2.y0()),
                               static_cast<int_x2_type>(site3.x1()) -
                               ...
                               static_cast<int_x2_type>(site3.y1()) -
                                   static_cast<int_x2_type>(site3.y0())),
          to_fpt(1.0));
      robust_fpt_type cross_31(
          robust_cross_product(static_cast<int_x2_type>(site3.x1()) -
                                   static_cast<int_x2_type>(site3.x0()),
                               static_cast<int_x2_type>(site3.y1()) -
                                   static_cast<int_x2_type>(site3.y0()),
                               static_cast<int_x2_type>(site1.x1()) -
      ...
      if (recompute_c_x || recompute_c_y || recompute_lower_x) {
        exact_circle_formation_functor_.sss(site1, site2, site3, c_event,
                                            recompute_c_x, recompute_c_y,
                                            recompute_lower_x);
      }
    }
  ...
  class circle_formation_predicate {
   ...
   private:
    bool lies_outside_vertical_segment(const circle_type& c,
                                       const site_type& s) {
